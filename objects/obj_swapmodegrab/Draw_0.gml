if isgustavo && scr_ispeppino()
	draw_sprite(spr_lonebrick_wait, image_index, xstart, ystart);
...
if room == boss_pizzaface && instance_exists(obj_pizzaface_thunderdark) && scr_isnoise()
{
