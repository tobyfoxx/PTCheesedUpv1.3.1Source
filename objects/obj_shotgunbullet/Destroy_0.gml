...
{
	repeat (6)
		create_particle(x + random_range(-25, 25), y + random_range(-25, 25), part.shotgunimpact, 0);
}
else
{
	repeat (6)
		create_particle(x - (32 * image_xscale) + random_range(-25, 25), y + random_range(-25, 25), part.shotgunimpact, 0);
}
