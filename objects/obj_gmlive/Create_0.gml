...
if live_enabled
{
	...
	live_function_add("fmod_event_instance_get_pitch(inst)", function(inst) {
	    return fmod_event_instance_get_pitch(inst);
	});
	live_function_add("fmod_event_one_shot_3d_volume(event, x, y, volume)", function(event, x, y, volume) {
	    return fmod_event_one_shot_3d_volume(event, x, y, volume);
	});
	...
	live_function_add("fmod_soundtest_get_events(bank_handle)", function(bank_handle) {
	    return fmod_soundtest_get_events(bank_handle);
	});
	live_function_add("fmod_soundtest_get_song_name(index)", function(index) {
	    return fmod_soundtest_get_song_name(index);
	});
	live_function_add("fmod_soundtest_get_song_category(index)", function(index) {
	    return fmod_soundtest_get_song_category(index);
	});
	live_function_add("fmod_soundtest_get_song_event(index)", function(index) {
	    return fmod_soundtest_get_song_event(index);
	});
	live_function_add("fmod_soundtest_get_song_index(index)", function(index) {
	    return fmod_soundtest_get_song_index(index);
	});
	live_function_add("fmod_soundtest_get_song_alt(index)", function(index) {
	    return fmod_soundtest_get_song_alt(index);
	});
	...
	live_function_add("image_get_size(filename)", function(filename) {
	    return image_get_size(filename);
	});
