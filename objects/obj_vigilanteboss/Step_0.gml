...
if (((phase == 1 && elitehit <= 0) || (phase == 2 && elitehit <= 0)) && !pizzahead)
{
	if (phase == 1)
	{
		...
		if check_char("V")
		{
			layer_background_change(bg2, bg_snottyboss_dark)
			layer_background_change(bg1, bg_snottyarena_dark)
			layer_background_change(layer_background_get_id("Backgrounds_scroll1"), bg_snottybg)
		}
		else
		{
