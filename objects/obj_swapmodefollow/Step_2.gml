var character = global.swap_characters[swap_index];
var _x = x, _y = y;
...
else if sprite_index != spr_air && (sprite_index != spr_playerN_doublejumpfall || character != "N") && animatronic <= 0
{
