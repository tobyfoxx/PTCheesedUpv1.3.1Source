...
if character == "N" && room == boss_pizzaface && instance_exists(obj_pizzaface_thunderdark)
	spr_pal = spr_noisepalette_rage;

pattern_set_temp(color_array, sprite_index, image_index, image_xscale, image_yscale, patterntexture);
