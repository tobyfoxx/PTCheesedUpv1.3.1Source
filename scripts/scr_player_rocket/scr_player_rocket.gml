function scr_player_rocket()
{
	...
	if (scr_isnoise() && sprite_index == spr_rocketstart)
	{
	...
	if (fightball == 0)
	{
		...
		{
			sprite_index = rocket;
			if (grounded && vsp >= 0 && scr_ispeppino())
	...
	if (grounded)
	{
		...
		if (scr_ispeppino() && move != 0 && move != xscale && sprite_index != rocketstart && state != states.mach2)
		{
