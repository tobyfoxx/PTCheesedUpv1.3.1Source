function pattern_set_sprite(sprite, subimg, xscale, yscale, xoffset = 0, yoffset = 0)
{
	...
	shader_set_uniform_f(shader_get_uniform(global.Pal_Shader, "pattern_offset"), xoffset, yoffset);
}
