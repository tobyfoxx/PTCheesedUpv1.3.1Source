...
{
	if safe_get(obj_shell, "isOpen") or safe_get(obj_onlinechat, "isOpen") or global.input_buffer > 0
	{
		scr_init_input();
		key_back = false;
		key_delete = false;
...
function scr_getinput(is_menu = false)
{
	...
	if (safe_get(obj_shell, "isOpen") or safe_get(obj_onlinechat, "isOpen") or instance_exists(obj_replay))
	or instance_exists(obj_softlockcrash)
	or (global.in_menu && !is_menu) or global.input_buffer > 0
	{
		scr_init_input();
		exit;
	}
	...
	{
		key_up = obj_replay.key_up;
		key_up2 = obj_replay.key_up2;
		key_right = obj_replay.key_right;
		key_right2 = obj_replay.key_right2;
		key_left = obj_replay.key_left;
		key_left2 = obj_replay.key_left2;
		key_down = obj_replay.key_down;
		key_down2 = obj_replay.key_down2;
		key_jump = obj_replay.key_jump;
		key_jump2 = obj_replay.key_jump2;
		key_slap = obj_replay.key_slap;
		key_slap2 = obj_replay.key_slap2;
		key_taunt = obj_replay.key_taunt;
		key_taunt2 = obj_replay.key_taunt2;
		key_attack = obj_replay.key_attack;
		key_attack2 = obj_replay.key_attack2;
		key_chainsaw = obj_replay.key_chainsaw;
		key_chainsaw2 = obj_replay.key_chainsaw2;
		key_shoot = obj_replay.key_shoot;
		key_shoot2 = obj_replay.key_shoot2;
		key_superjump = obj_replay.key_superjump;
		key_groundpound = obj_replay.key_groundpound;
		key_groundpound2 = obj_replay.key_groundpound2;
		key_left_axis = obj_replay.key_left_axis;
		key_right_axis = obj_replay.key_right_axis;
		key_up_axis = obj_replay.key_up_axis;
		key_down_axis = obj_replay.key_down_axis;
		exit;
	}
