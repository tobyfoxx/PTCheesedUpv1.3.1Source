...
function scr_initinput(open_savedata = true)
{
	...
	tdp_input_ini_read("player_chainsaw", [tdp_action(tdp_input.keyboard, ord("V"))]);
	...
	tdp_input_ini_read("player_chainsawC", [tdp_action(tdp_input.gamepad, gp_shoulderl), tdp_action(tdp_input.gamepad, gp_shoulderlb)]);
